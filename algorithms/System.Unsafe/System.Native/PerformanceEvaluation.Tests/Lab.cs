...
namespace MatrixExtensionsTestProject
{
    ...
    public static class Lab
    {
        ...
        {
            var xb = new Block(0, x.RowCount(), 0, x.ColumnCount());
            var yb = new Block(0, y.RowCount(), 0, y.ColumnCount());
            ...
            var p1 = Multiply(x11, y12.Substract(y22));
            var p2 = Multiply(x11.Add(x12), y22);
            var p3 = Multiply(x21.Add(x22), y11);
            var p4 = Multiply(x22, y21.Substract(y11));
            var p5 = Multiply(x11.Add(x22), y11.Add(y22));
            var p6 = Multiply(x12.Substract(x22), y21.Substract(y22));
            var p7 = Multiply(x11.Substract(x12), y11.Substract(y12));
