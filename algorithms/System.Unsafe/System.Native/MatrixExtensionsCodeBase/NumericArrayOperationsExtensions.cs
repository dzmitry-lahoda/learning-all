...
namespace MatrixExtensions.Operations
{
    ...
    /// </summary>
    [Pure]
    public  static class NumericArrayOperationsExtensions
    {
        ...
        public static NumericBroad[] Add(this NumericBroad[] vector, NumericNarrow[] other)
        {
        ...
        public static NumericBroad[] Substract(this NumericBroad[] vector, NumericNarrow[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<NumericBroad[]>().Length == vector.Length);
        ...
        public static NumericBroad[] PointwiseMultiply(this NumericBroad[] vector, NumericNarrow[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<NumericBroad[]>().Length == vector.Length);
