...
namespace MatrixExtensions.Conversion.Explicit
{
    ...
    /// </summary>
   [Pure]
    public static class DecimalIntExplicitConversionExtensions
    {
        /// <summary>
        ...
        public static int[] ToInt(this decimal[] vector)
        {
            ...
            Do.For(0, length, i => newVector[i] = (int)vector[i]);
            return newVector;
        }
        ...
        public static int[,] ToInt(this decimal[,] matrix)
        {
            ...
            Do.For2(0,rowCount,0,columnCount,(r,c) => newMatrix[r, c] = (int) matrix[r, c] );
            return newMatrix;
        }
