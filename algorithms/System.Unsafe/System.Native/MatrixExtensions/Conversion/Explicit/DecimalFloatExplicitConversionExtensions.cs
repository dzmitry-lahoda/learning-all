...
namespace MatrixExtensions.Conversion.Explicit
{
    ...
    /// </summary>
   [Pure]
    public static class DecimalFloatExplicitConversionExtensions
    {
        /// <summary>
        ...
        public static float[] ToFloat(this decimal[] vector)
        {
        ...
        public static float[,] ToFloat(this decimal[,] matrix)
        {
