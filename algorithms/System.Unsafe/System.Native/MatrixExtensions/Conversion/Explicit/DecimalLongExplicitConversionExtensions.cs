...
namespace MatrixExtensions.Conversion.Explicit
{
    ...
    /// </summary>
   [Pure]
    public static class DecimalLongExplicitConversionExtensions
    {
        /// <summary>
        ...
        public static long[] ToLong(this decimal[] vector)
        {
            ...
            Do.For(0, length, i => newVector[i] = (long)vector[i]);
            return newVector;
        }
        ...
        public static long[,] ToLong(this decimal[,] matrix)
        {
            ...
            Do.For2(0,rowCount,0,columnCount,(r,c) => newMatrix[r, c] = (long) matrix[r, c] );
            return newMatrix;
        }
