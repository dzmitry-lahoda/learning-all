...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class DoubleFloatArray2DSimpleOperationsExtensions
    {
        ...
        public static int[] MaxPosition(this double[,] matrix)
        {
        ...
        public static double[,] Add(this double[,] matrix, double scalar)
        {
        ...
        public static double[,] Substract(this double[,] matrix, double scalar)
        {
        ...
        public static double[,] PointwiseMultiply(this double[,] matrix, double scalar)
        {
            Contract.Ensures(Contract.Result<double[,]>().GetLength(0) == matrix.GetLength(0));
            Contract.Ensures(Contract.Result<double[,]>().GetLength(1) == matrix.GetLength(1));
            var rowCount = matrix.GetLength(0);
        ...
        public static double[,] DivideEachElement(this double[,] matrix, double scalar)
        {
            Contract.Ensures(Contract.Result<double[,]>().GetLength(0) == matrix.GetLength(0));
            Contract.Ensures(Contract.Result<double[,]>().GetLength(1) == matrix.GetLength(1));
            var rowCount = matrix.GetLength(0);
        ...
        public static double[] SumPerColumn(this double[,] matrix)
        {
            Contract.Ensures(Contract.Result<double[]>().Length == matrix.GetLength(1));
            var rowCount = matrix.GetLength(0);
            var columnCount = matrix.GetLength(1);
            var newVector = new double[columnCount];
        ...
        /// <param name="matrix"></param>
        /// <returns>The vector which contains sums.</returns>
        public static double[] SumPerRow(this double[,] matrix)
        {
            Contract.Ensures(Contract.Result<double[]>().Length == matrix.GetLength(1));
            var rowCount = matrix.GetLength(0);
            var columnCount = matrix.GetLength(1);
            var newVector = new double[rowCount];
