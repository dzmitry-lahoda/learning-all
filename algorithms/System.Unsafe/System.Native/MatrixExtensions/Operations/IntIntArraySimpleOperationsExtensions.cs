...
namespace MatrixExtensions.Operations
{
    ...
    /// </summary>
    [Pure]
    public static class IntIntArraySimpleOperationsExtensions
    {
        ...
        public static int MaxPosition(this int[] vector)
        {
        ...
        public static int[] Add(this int[] vector, int scalar)
        {
        ...
        public static int[] Substract(this int[] vector, int scalar)
        {
        ...
        public static int[] PointwiseMultiply(this int[] vector, int scalar)
        {
            Contract.Ensures(Contract.Result<int[]>().Length == vector.Length);
            var length = vector.Length;
            var newVector = new int[length];
        ...
        public static int[] DivideEachElement(this int[] vector, int scalar)
        {
