...
namespace MatrixExtensions.Operations
{
    ...
    /// </summary>
    [Pure]
    public  static class LongIntArrayOperationsExtensions
    {
        ...
        public static long[] Add(this long[] vector, int[] other)
        {
        ...
        public static long[] Substract(this long[] vector, int[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<long[]>().Length == vector.Length);
        ...
        public static long[] PointwiseMultiply(this long[] vector, int[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<long[]>().Length == vector.Length);
