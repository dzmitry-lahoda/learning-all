...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class DoubleDoubleArray2DOperationsExtensions
    {
        ...
        public static double[,] Add(this double[,] matrix, double[,] other)
        {
        ...
        public static double[,] Substract(this double[,] matrix, double[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static double[,] PointwiseMultiply(this double[,] matrix, double[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static double[,] Multiply(this double[,] matrix, double[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(0));
            Contract.Ensures(Contract.Result<double[,]>().GetLength(0) == matrix.GetLength(0));
            Contract.Ensures(Contract.Result<double[,]>().GetLength(1) == other.GetLength(1));
            var rowCount = matrix.GetLength(0);
        ...
        public static double[] Multiply(this double[,] matrix, double[] other)
        {
            ...
            Contract.Ensures(Contract.Result<double[]>().Length == matrix.GetLength(0));
            var rowCount = matrix.GetLength(0);
            var sumCount = matrix.GetLength(1);
