...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class IntIntArray2DOperationsExtensions
    {
        ...
        public static int[,] Add(this int[,] matrix, int[,] other)
        {
        ...
        public static int[,] Substract(this int[,] matrix, int[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static int[,] PointwiseMultiply(this int[,] matrix, int[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static int[,] Multiply(this int[,] matrix, int[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(0));
            Contract.Ensures(Contract.Result<int[,]>().GetLength(0) == matrix.GetLength(0));
            Contract.Ensures(Contract.Result<int[,]>().GetLength(1) == other.GetLength(1));
            var rowCount = matrix.GetLength(0);
        ...
        public static int[] Multiply(this int[,] matrix, int[] other)
        {
            ...
            Contract.Ensures(Contract.Result<int[]>().Length == matrix.GetLength(0));
            var rowCount = matrix.GetLength(0);
            var sumCount = matrix.GetLength(1);
