...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class DecimalLongArray2DOperationsExtensions
    {
        ...
        public static decimal[,] Add(this decimal[,] matrix, long[,] other)
        {
        ...
        public static decimal[,] Substract(this decimal[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static decimal[,] PointwiseMultiply(this decimal[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static decimal[,] Multiply(this decimal[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
