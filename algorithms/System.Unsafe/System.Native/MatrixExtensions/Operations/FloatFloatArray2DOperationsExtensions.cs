...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class FloatFloatArray2DOperationsExtensions
    {
        ...
        public static float[,] Add(this float[,] matrix, float[,] other)
        {
        ...
        public static float[,] Substract(this float[,] matrix, float[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static float[,] PointwiseMultiply(this float[,] matrix, float[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static float[,] Multiply(this float[,] matrix, float[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(0));
            Contract.Ensures(Contract.Result<float[,]>().GetLength(0) == matrix.GetLength(0));
            Contract.Ensures(Contract.Result<float[,]>().GetLength(1) == other.GetLength(1));
            var rowCount = matrix.GetLength(0);
        ...
        public static float[] Multiply(this float[,] matrix, float[] other)
        {
            ...
            Contract.Ensures(Contract.Result<float[]>().Length == matrix.GetLength(0));
            var rowCount = matrix.GetLength(0);
            var sumCount = matrix.GetLength(1);
