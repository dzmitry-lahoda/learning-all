...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class IntIntArray2DSimpleOperationsExtensions
    {
        ...
        public static int[] MaxPosition(this int[,] matrix)
        {
        ...
        public static int[,] Add(this int[,] matrix, int scalar)
        {
            Contract.Ensures(Contract.Result<int[,]>().GetLength(0) == matrix.GetLength(0));
            Contract.Ensures(Contract.Result<int[,]>().GetLength(1) == matrix.GetLength(1));
            var rowCount = matrix.GetLength(0);
            var columnCount = matrix.GetLength(1);
            var newMatrix = new int[rowCount, columnCount];
        ...
        public static int[,] Substract(this int[,] matrix, int scalar)
        {
        ...
        public static int[,] PointwiseMultiply(this int[,] matrix, int scalar)
        {
            Contract.Ensures(Contract.Result<int[,]>().GetLength(0) == matrix.GetLength(0));
            Contract.Ensures(Contract.Result<int[,]>().GetLength(1) == matrix.GetLength(1));
            var rowCount = matrix.GetLength(0);
        ...
        public static int[,] DivideEachElement(this int[,] matrix, int scalar)
        {
            Contract.Ensures(Contract.Result<int[,]>().GetLength(0) == matrix.GetLength(0));
            Contract.Ensures(Contract.Result<int[,]>().GetLength(1) == matrix.GetLength(1));
            var rowCount = matrix.GetLength(0);
        ...
        public static int[] SumPerColumn(this int[,] matrix)
        {
            Contract.Ensures(Contract.Result<int[]>().Length == matrix.GetLength(1));
            var rowCount = matrix.GetLength(0);
            var columnCount = matrix.GetLength(1);
            var newVector = new int[columnCount];
        ...
        /// <param name="matrix"></param>
        /// <returns>The vector which contains sums.</returns>
        public static int[] SumPerRow(this int[,] matrix)
        {
            Contract.Ensures(Contract.Result<int[]>().Length == matrix.GetLength(1));
            var rowCount = matrix.GetLength(0);
            var columnCount = matrix.GetLength(1);
            var newVector = new int[rowCount];
