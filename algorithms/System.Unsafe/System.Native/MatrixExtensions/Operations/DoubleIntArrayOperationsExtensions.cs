...
namespace MatrixExtensions.Operations
{
    ...
    /// </summary>
    [Pure]
    public  static class DoubleIntArrayOperationsExtensions
    {
        ...
        public static double[] Add(this double[] vector, int[] other)
        {
        ...
        public static double[] Substract(this double[] vector, int[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<double[]>().Length == vector.Length);
        ...
        public static double[] PointwiseMultiply(this double[] vector, int[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<double[]>().Length == vector.Length);
