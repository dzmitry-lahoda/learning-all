...
namespace MatrixExtensions.Operations
{
    ...
    /// </summary>
    [Pure]
    public  static class DoubleFloatArrayOperationsExtensions
    {
        ...
        public static double[] Add(this double[] vector, float[] other)
        {
        ...
        public static double[] Substract(this double[] vector, float[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<double[]>().Length == vector.Length);
        ...
        public static double[] PointwiseMultiply(this double[] vector, float[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<double[]>().Length == vector.Length);
