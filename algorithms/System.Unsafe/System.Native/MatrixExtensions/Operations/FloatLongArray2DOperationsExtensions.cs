...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class FloatLongArray2DOperationsExtensions
    {
        ...
        public static float[,] Add(this float[,] matrix, long[,] other)
        {
        ...
        public static float[,] Substract(this float[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static float[,] PointwiseMultiply(this float[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static float[,] Multiply(this float[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
