...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class DoubleIntArray2DOperationsExtensions
    {
        ...
        public static double[,] Add(this double[,] matrix, int[,] other)
        {
        ...
        public static double[,] Substract(this double[,] matrix, int[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static double[,] PointwiseMultiply(this double[,] matrix, int[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static double[,] Multiply(this double[,] matrix, int[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
