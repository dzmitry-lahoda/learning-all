...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class DoubleLongArray2DOperationsExtensions
    {
        ...
        public static double[,] Add(this double[,] matrix, long[,] other)
        {
        ...
        public static double[,] Substract(this double[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static double[,] PointwiseMultiply(this double[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static double[,] Multiply(this double[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
