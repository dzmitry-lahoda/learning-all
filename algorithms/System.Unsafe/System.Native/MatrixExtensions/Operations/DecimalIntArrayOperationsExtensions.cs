...
namespace MatrixExtensions.Operations
{
    ...
    /// </summary>
    [Pure]
    public  static class DecimalIntArrayOperationsExtensions
    {
        ...
        public static decimal[] Add(this decimal[] vector, int[] other)
        {
        ...
        public static decimal[] Substract(this decimal[] vector, int[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<decimal[]>().Length == vector.Length);
        ...
        public static decimal[] PointwiseMultiply(this decimal[] vector, int[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<decimal[]>().Length == vector.Length);
