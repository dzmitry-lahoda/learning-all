...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class LongIntArray2DOperationsExtensions
    {
        ...
        public static long[,] Add(this long[,] matrix, int[,] other)
        {
        ...
        public static long[,] Substract(this long[,] matrix, int[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static long[,] PointwiseMultiply(this long[,] matrix, int[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static long[,] Multiply(this long[,] matrix, int[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
