...
namespace MatrixExtensions.Operations
{
    ...
    /// </summary>
    [Pure]
    public  static class FloatIntArrayOperationsExtensions
    {
        ...
        public static float[] Add(this float[] vector, int[] other)
        {
        ...
        public static float[] Substract(this float[] vector, int[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<float[]>().Length == vector.Length);
        ...
        public static float[] PointwiseMultiply(this float[] vector, int[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<float[]>().Length == vector.Length);
