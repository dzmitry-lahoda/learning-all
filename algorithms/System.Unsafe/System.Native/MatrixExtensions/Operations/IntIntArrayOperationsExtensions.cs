...
namespace MatrixExtensions.Operations
{
    ...
    /// </summary>
    [Pure]
    public  static class IntIntArrayOperationsExtensions
    {
        ...
        public static int[] Add(this int[] vector, int[] other)
        {
        ...
        public static int[] Substract(this int[] vector, int[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<int[]>().Length == vector.Length);
        ...
        public static int[] PointwiseMultiply(this int[] vector, int[] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(vector.Length == other.Length);
            Contract.Ensures(Contract.Result<int[]>().Length == vector.Length);
