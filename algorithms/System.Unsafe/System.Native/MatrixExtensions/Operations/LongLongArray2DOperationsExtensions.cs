...
namespace MatrixExtensions.Operations
{
    ...
    [Pure]
    public static class LongLongArray2DOperationsExtensions
    {
        ...
        public static long[,] Add(this long[,] matrix, long[,] other)
        {
        ...
        public static long[,] Substract(this long[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static long[,] PointwiseMultiply(this long[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == other.GetLength(0));
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(1));
        ...
        public static long[,] Multiply(this long[,] matrix, long[,] other)
        {
            Contract.Requires<ArgumentNullException>(other != null);
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == other.GetLength(0));
            Contract.Ensures(Contract.Result<long[,]>().GetLength(0) == matrix.GetLength(0));
            Contract.Ensures(Contract.Result<long[,]>().GetLength(1) == other.GetLength(1));
            var rowCount = matrix.GetLength(0);
        ...
        public static long[] Multiply(this long[,] matrix, long[] other)
        {
            ...
            Contract.Ensures(Contract.Result<long[]>().Length == matrix.GetLength(0));
            var rowCount = matrix.GetLength(0);
            var sumCount = matrix.GetLength(1);
