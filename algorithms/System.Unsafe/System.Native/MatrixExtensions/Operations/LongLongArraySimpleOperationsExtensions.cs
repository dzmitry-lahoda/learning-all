...
namespace MatrixExtensions.Operations
{
    ...
    /// </summary>
    [Pure]
    public static class LongLongArraySimpleOperationsExtensions
    {
        ...
        public static int MaxPosition(this long[] vector)
        {
        ...
        public static long[] Add(this long[] vector, long scalar)
        {
        ...
        public static long[] Substract(this long[] vector, long scalar)
        {
        ...
        public static long[] PointwiseMultiply(this long[] vector, long scalar)
        {
            Contract.Ensures(Contract.Result<long[]>().Length == vector.Length);
            var length = vector.Length;
            var newVector = new long[length];
        ...
        public static long[] DivideEachElement(this long[] vector, long scalar)
        {
