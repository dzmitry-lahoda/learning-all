...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class LongIntArrayManipulationExtensions
    {
        ...
        public static long[] Append(this long[] vector, int[] right)
        {
        ...
        public static long[,] Stack(this long[] vector, int[] bottom)
        {
