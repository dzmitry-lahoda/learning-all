...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DecimalDecimalArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static decimal[,] Append(this decimal[,] matrix, decimal[] right)
        {
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == right.Length);
            Contract.Ensures(Contract.Result<decimal[,]>().GetLength(1) == matrix.GetLength(1) + 1);
        ...
        public static decimal[,] Append(this decimal[,] matrix, decimal[,] right)
        {
            ...
            Contract.Ensures(Contract.Result<decimal[,]>().GetLength(1) == matrix.GetLength(1) + right.GetLength(1));
        ...
        /// <returns>The combined matrix.</returns>
        public static decimal[,] Stack(this decimal[,] matrix, decimal[] bottom)
        {
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == bottom.Length);
            Contract.Ensures(Contract.Result<decimal[,]>().GetLength(0) == matrix.GetLength(0) + 1);
        ...
        public static decimal[,] Stack(this decimal[,] matrix, decimal[,] bottom)
        {
            ...
            Contract.Ensures(Contract.Result<decimal[,]>().GetLength(0) == matrix.GetLength(0) + bottom.GetLength(0));
