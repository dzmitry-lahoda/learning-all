...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DecimalLongArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static decimal[,] Append(this decimal[,] matrix, long[] right)
        {
        ...
        /// <returns>The combined matrix.</returns>
        public static decimal[,] Stack(this decimal[,] matrix, long[] bottom)
        {
