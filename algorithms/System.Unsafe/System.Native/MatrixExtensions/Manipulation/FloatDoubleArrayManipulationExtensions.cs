...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class FloatDoubleArrayManipulationExtensions
    {
        ...
        public static double[] Append(this float[] vector, double[] right)
        {
        ...
        public static double[,] Stack(this float[] vector, double[] bottom)
        {
