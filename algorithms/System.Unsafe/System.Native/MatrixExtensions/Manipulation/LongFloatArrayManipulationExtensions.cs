...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class LongFloatArrayManipulationExtensions
    {
        ...
        public static float[] Append(this long[] vector, float[] right)
        {
        ...
        public static float[,] Stack(this long[] vector, float[] bottom)
        {
