...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class FloatFloatArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static float[,] Append(this float[,] matrix, float[] right)
        {
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == right.Length);
            Contract.Ensures(Contract.Result<float[,]>().GetLength(1) == matrix.GetLength(1) + 1);
        ...
        public static float[,] Append(this float[,] matrix, float[,] right)
        {
            ...
            Contract.Ensures(Contract.Result<float[,]>().GetLength(1) == matrix.GetLength(1) + right.GetLength(1));
        ...
        /// <returns>The combined matrix.</returns>
        public static float[,] Stack(this float[,] matrix, float[] bottom)
        {
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == bottom.Length);
            Contract.Ensures(Contract.Result<float[,]>().GetLength(0) == matrix.GetLength(0) + 1);
        ...
        public static float[,] Stack(this float[,] matrix, float[,] bottom)
        {
            ...
            Contract.Ensures(Contract.Result<float[,]>().GetLength(0) == matrix.GetLength(0) + bottom.GetLength(0));
