...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class IntLongArrayManipulationExtensions
    {
        ...
        public static long[] Append(this int[] vector, long[] right)
        {
        ...
        public static long[,] Stack(this int[] vector, long[] bottom)
        {
