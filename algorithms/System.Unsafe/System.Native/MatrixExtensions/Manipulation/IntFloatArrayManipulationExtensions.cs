...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class IntFloatArrayManipulationExtensions
    {
        ...
        public static float[] Append(this int[] vector, float[] right)
        {
        ...
        public static float[,] Stack(this int[] vector, float[] bottom)
        {
