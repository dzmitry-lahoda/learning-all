...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class LongIntArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static long[,] Append(this long[,] matrix, int[] right)
        {
        ...
        /// <returns>The combined matrix.</returns>
        public static long[,] Stack(this long[,] matrix, int[] bottom)
        {
