...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class FloatLongArrayManipulationExtensions
    {
        ...
        public static float[] Append(this float[] vector, long[] right)
        {
        ...
        public static float[,] Stack(this float[] vector, long[] bottom)
        {
