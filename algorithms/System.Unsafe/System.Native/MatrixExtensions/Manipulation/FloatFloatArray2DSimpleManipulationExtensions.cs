...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class FloatFloatArray2DSimpleManipulationExtensions
    {
        ...
        public static float[] ToColumnWiseArray(this float[,] matrix)
        {
            Contract.Ensures(Contract.Result<float[]>().Length == matrix.GetLength(1) * matrix.GetLength(0));
            var rowCount = matrix.GetLength(0);
            var columnCount = matrix.GetLength(1);
            var newVector = new float[rowCount * columnCount];
        ...
        /// </pre></example>
        /// <returns>The new vector containing the matrix's elements.</returns>
        public static float[] ToRowWiseArray(this float[,] matrix)
        {
            Contract.Ensures(Contract.Result<float[]>().Length == matrix.GetLength(1) * matrix.GetLength(0));
            var rowCount = matrix.GetLength(0);
            var columnCount = matrix.GetLength(1);
