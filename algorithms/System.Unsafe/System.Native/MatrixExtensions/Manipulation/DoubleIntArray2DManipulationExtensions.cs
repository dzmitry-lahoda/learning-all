...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DoubleIntArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static double[,] Append(this double[,] matrix, int[] right)
        {
        ...
        /// <returns>The combined matrix.</returns>
        public static double[,] Stack(this double[,] matrix, int[] bottom)
        {
