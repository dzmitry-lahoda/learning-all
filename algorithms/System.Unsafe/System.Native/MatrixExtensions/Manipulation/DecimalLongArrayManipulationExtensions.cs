...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DecimalLongArrayManipulationExtensions
    {
        ...
        public static decimal[] Append(this decimal[] vector, long[] right)
        {
        ...
        public static decimal[,] Stack(this decimal[] vector, long[] bottom)
        {
