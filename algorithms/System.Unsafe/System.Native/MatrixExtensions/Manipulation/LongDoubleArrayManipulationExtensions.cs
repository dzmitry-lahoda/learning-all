...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class LongDoubleArrayManipulationExtensions
    {
        ...
        public static double[] Append(this long[] vector, double[] right)
        {
        ...
        public static double[,] Stack(this long[] vector, double[] bottom)
        {
