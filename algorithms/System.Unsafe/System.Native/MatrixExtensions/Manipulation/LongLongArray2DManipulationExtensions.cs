...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class LongLongArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static long[,] Append(this long[,] matrix, long[] right)
        {
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == right.Length);
            Contract.Ensures(Contract.Result<long[,]>().GetLength(1) == matrix.GetLength(1) + 1);
        ...
        public static long[,] Append(this long[,] matrix, long[,] right)
        {
            ...
            Contract.Ensures(Contract.Result<long[,]>().GetLength(1) == matrix.GetLength(1) + right.GetLength(1));
        ...
        /// <returns>The combined matrix.</returns>
        public static long[,] Stack(this long[,] matrix, long[] bottom)
        {
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == bottom.Length);
            Contract.Ensures(Contract.Result<long[,]>().GetLength(0) == matrix.GetLength(0) + 1);
        ...
        public static long[,] Stack(this long[,] matrix, long[,] bottom)
        {
            ...
            Contract.Ensures(Contract.Result<long[,]>().GetLength(0) == matrix.GetLength(0) + bottom.GetLength(0));
