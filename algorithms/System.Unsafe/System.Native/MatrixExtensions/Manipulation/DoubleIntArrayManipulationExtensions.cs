...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DoubleIntArrayManipulationExtensions
    {
        ...
        public static double[] Append(this double[] vector, int[] right)
        {
        ...
        public static double[,] Stack(this double[] vector, int[] bottom)
        {
