...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class IntDoubleArrayManipulationExtensions
    {
        ...
        public static double[] Append(this int[] vector, double[] right)
        {
        ...
        public static double[,] Stack(this int[] vector, double[] bottom)
        {
