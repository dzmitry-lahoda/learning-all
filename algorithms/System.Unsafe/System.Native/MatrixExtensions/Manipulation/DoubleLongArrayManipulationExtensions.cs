...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DoubleLongArrayManipulationExtensions
    {
        ...
        public static double[] Append(this double[] vector, long[] right)
        {
        ...
        public static double[,] Stack(this double[] vector, long[] bottom)
        {
