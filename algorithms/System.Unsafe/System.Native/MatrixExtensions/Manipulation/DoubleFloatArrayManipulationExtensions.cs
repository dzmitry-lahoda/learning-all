...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DoubleFloatArrayManipulationExtensions
    {
        ...
        public static double[] Append(this double[] vector, float[] right)
        {
        ...
        public static double[,] Stack(this double[] vector, float[] bottom)
        {
