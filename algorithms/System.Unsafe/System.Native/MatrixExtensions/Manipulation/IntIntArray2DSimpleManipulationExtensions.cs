...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class IntIntArray2DSimpleManipulationExtensions
    {
        ...
        public static int[] ToColumnWiseArray(this int[,] matrix)
        {
            Contract.Ensures(Contract.Result<int[]>().Length == matrix.GetLength(1) * matrix.GetLength(0));
            var rowCount = matrix.GetLength(0);
            var columnCount = matrix.GetLength(1);
            var newVector = new int[rowCount * columnCount];
        ...
        /// </pre></example>
        /// <returns>The new vector containing the matrix's elements.</returns>
        public static int[] ToRowWiseArray(this int[,] matrix)
        {
            Contract.Ensures(Contract.Result<int[]>().Length == matrix.GetLength(1) * matrix.GetLength(0));
            var rowCount = matrix.GetLength(0);
            var columnCount = matrix.GetLength(1);
