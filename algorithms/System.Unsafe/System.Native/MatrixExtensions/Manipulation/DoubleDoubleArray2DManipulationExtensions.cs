...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DoubleDoubleArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static double[,] Append(this double[,] matrix, double[] right)
        {
            Contract.Requires<ArgumentException>(matrix.GetLength(0) == right.Length);
            Contract.Ensures(Contract.Result<double[,]>().GetLength(1) == matrix.GetLength(1) + 1);
        ...
        public static double[,] Append(this double[,] matrix, double[,] right)
        {
            ...
            Contract.Ensures(Contract.Result<double[,]>().GetLength(1) == matrix.GetLength(1) + right.GetLength(1));
        ...
        /// <returns>The combined matrix.</returns>
        public static double[,] Stack(this double[,] matrix, double[] bottom)
        {
            Contract.Requires<ArgumentException>(matrix.GetLength(1) == bottom.Length);
            Contract.Ensures(Contract.Result<double[,]>().GetLength(0) == matrix.GetLength(0) + 1);
        ...
        public static double[,] Stack(this double[,] matrix, double[,] bottom)
        {
            ...
            Contract.Ensures(Contract.Result<double[,]>().GetLength(0) == matrix.GetLength(0) + bottom.GetLength(0));
