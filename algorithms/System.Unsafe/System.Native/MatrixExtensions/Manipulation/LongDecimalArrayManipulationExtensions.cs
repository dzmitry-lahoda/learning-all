...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class LongDecimalArrayManipulationExtensions
    {
        ...
        public static decimal[] Append(this long[] vector, decimal[] right)
        {
        ...
        public static decimal[,] Stack(this long[] vector, decimal[] bottom)
        {
