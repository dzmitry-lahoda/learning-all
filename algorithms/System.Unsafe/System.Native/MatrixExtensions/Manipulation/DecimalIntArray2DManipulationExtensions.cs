...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DecimalIntArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static decimal[,] Append(this decimal[,] matrix, int[] right)
        {
        ...
        /// <returns>The combined matrix.</returns>
        public static decimal[,] Stack(this decimal[,] matrix, int[] bottom)
        {
