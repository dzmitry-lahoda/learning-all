...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DoubleFloatArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static double[,] Append(this double[,] matrix, float[] right)
        {
        ...
        /// <returns>The combined matrix.</returns>
        public static double[,] Stack(this double[,] matrix, float[] bottom)
        {
