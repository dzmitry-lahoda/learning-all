...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class FloatLongArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static float[,] Append(this float[,] matrix, long[] right)
        {
        ...
        /// <returns>The combined matrix.</returns>
        public static float[,] Stack(this float[,] matrix, long[] bottom)
        {
