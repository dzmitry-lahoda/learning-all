...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class FloatIntArrayManipulationExtensions
    {
        ...
        public static float[] Append(this float[] vector, int[] right)
        {
        ...
        public static float[,] Stack(this float[] vector, int[] bottom)
        {
