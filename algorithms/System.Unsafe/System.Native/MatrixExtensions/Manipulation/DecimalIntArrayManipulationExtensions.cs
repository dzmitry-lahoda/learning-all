...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DecimalIntArrayManipulationExtensions
    {
        ...
        public static decimal[] Append(this decimal[] vector, int[] right)
        {
        ...
        public static decimal[,] Stack(this decimal[] vector, int[] bottom)
        {
