...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class IntDecimalArrayManipulationExtensions
    {
        ...
        public static decimal[] Append(this int[] vector, decimal[] right)
        {
        ...
        public static decimal[,] Stack(this int[] vector, decimal[] bottom)
        {
