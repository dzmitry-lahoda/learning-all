...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class DoubleLongArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static double[,] Append(this double[,] matrix, long[] right)
        {
        ...
        /// <returns>The combined matrix.</returns>
        public static double[,] Stack(this double[,] matrix, long[] bottom)
        {
