...
namespace MatrixExtensions.Manipulation
{
    ...
    /// </summary>
    [Pure]
    public static class FloatIntArray2DManipulationExtensions
    {
        /// <summary>
        ...
        public static float[,] Append(this float[,] matrix, int[] right)
        {
        ...
        /// <returns>The combined matrix.</returns>
        public static float[,] Stack(this float[,] matrix, int[] bottom)
        {
